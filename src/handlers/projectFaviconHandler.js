...
const serveFavicon = (contentType) => (c) =>
  c.body(getFavicon(), 200, {
    "Content-Type": contentType,
    "Cache-Control": CACHE_TIME,
  });

export const handleFaviconSvg = serveFavicon("image/svg+xml; charset=utf-8");
export const handleFaviconIco = serveFavicon("image/svg+xml; charset=utf-8");
export const handleAppleTouchIcon = serveFavicon(
